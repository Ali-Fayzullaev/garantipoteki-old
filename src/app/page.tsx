      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-primary-50/20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <button
              className="swiper-button-prev-custom absolute left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center text-gray-600 hover:scale-110 group"
              onMouseEnter={(e) => (e.currentTarget.style.color = "#DE6A2A")}
            ...
            <button
              className="swiper-button-next-custom absolute right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center text-gray-600 hover:scale-110 group"
              onMouseEnter={(e) => (e.currentTarget.style.color = "#DE6A2A")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "#4b5563")}
            >
              <svg
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-xl mb-8 text-orange-100">
                Получите бесплатную консультацию и узнайте свои возможности уже
                сегодня
              </p>
              <button
                onClick={openModal}
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-primary-50/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div
                className="h-full bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-b-4 border-brand group-hover:-translate-y-2"
                style={{ borderBottomColor: "#F6DB4A" }}
              >
