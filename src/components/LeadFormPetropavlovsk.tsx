// src/components/LeadFormPetropavlovsk.tsx
'use client';
...
interface LeadFormPetropavlovskProps {
  onSuccess?: () => void;
}

function LeadFormPetropavlovsk({ onSuccess }: LeadFormPetropavlovskProps) {
    ...
    try {
      const response = await fetch('/api/submit-form', {
        ...
        body: JSON.stringify({
          ...
          cityCode: 'petropavlovsk', // Жестко задан код города
        }),
      });
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-green-800">
                  ...
                  <span className="font-semibold">Отправлено в офис Петропавловск</span>
                </div>
                <p className="text-green-700">
                  Наш специалист из Петропавловска свяжется с вами в ближайшее время
                </p>
              </div>
            </motion.div>
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-2">
          Консультация в Петропавловске
        </h3>
        <p className="text-gray-600">
          Наш эксперт из офиса Петропавловск свяжется с вами в течение 5 минут
        </p>
      </div>
        ...
        >
          {isLoading ? (
            ...
            <span className="flex items-center justify-center gap-2">
              ...
              Получить консультацию в Петропавловске
            </span>
          )}
        </motion.button>

        <p className="text-xs text-gray-500 text-center">
          Заявка будет отправлена в офис Петропавловск: +7 708 153 7750
        </p>
      </form>
    </motion.div>
  );
...
export default LeadFormPetropavlovsk;